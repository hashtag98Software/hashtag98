				...
				<div className={s.section_footer__footer__content}>
					...
					<div className={s.section_footer__footer__content__info}>
						...
						<ul className={s.section_footer__footer__content__info__list}>
							...
							<li>
								<a href="tel:+573146596818">
									Jefe de Recepción: +57 314659 6818
								</a>
							</li>
						</ul>
					</div>
					<div className={s.section_footer__footer__content__text}>
						...
						<ul>
							<li
								className={s.section_footer__footer__content__text__list__item}
							>
								1) Cualquier persona que pretenda ofrecer servicios o planes
								relacionados con la Explotación Sexual Comercial de Niños, Niñas
								y Adolescentes.
							</li>
							<li
								className={s.section_footer__footer__content__text__list__item}
							>
								...
								sus padres o tutores o que no estén debidamente autorizados por
								estos.
							</li>
						</ul>
						<br />
						<p>
							...
							de lo dispuesto en el artículo 17 de la Ley 679 de 2001, La Ley
							1098 de 2006, La Ley 1336 de 2009, la Resolución 3840 de 2009 y
							Código Ético MundialPara el Turismo, la explotación y el abuso
							sexual de menores de edad (Niños, Niñas y Adolescentes) en el
							país, son sancionados con Penas de hasta 20 años de cárcel y
